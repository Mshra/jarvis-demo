      ...
      <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
        <div className="h-screen w-screen dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative">
          ...
          <div className="flex justify-center">
            <ul className="flex items-center justify-evenly gap-4 p-1 mt-40 border border-black rounded-full dark:border-white bg-white dark:bg-black w-11/12 md:w-7/12 lg:w-5/12">
              <li>
              ...
              <li>
                <a
                  href="https://www.npmjs.com/package/@tarzi/jarvis"
                  target="_blank"
                >
                  <svg
                    width="40"
